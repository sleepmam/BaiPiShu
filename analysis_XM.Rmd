...
ggplot(data_vis_pwb, aes(x = PWB, y = PWB_val, fill = as.factor(gpa_grp))) + geom_bar(stat="identity", position=position_dodge()) + scale_fill_brewer(palette="Greys")

View(data_vis_pwb)

ggplot(data_vis_lt, aes(x = Latent, y = Lt_val, fill = gpa_grp)) + geom_bar(stat="identity", position=position_dodge()) + scale_fill_brewer(palette="Set3") 
