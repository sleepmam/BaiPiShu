...
table_10 <- tableby(ICE ~ age_grp + gender_grp + degree_grp + religion_grp + sex_o_grp + sib_grp + visa_grp + gpa_grp + gpa_change_grp, 
                    data = data_vis,
                    control = my_controls)
summary(table_10, title = "demo by ICE", text = TRUE)
