...
df_f <- as.data.frame(data_0722_t)[,-c(283:289)] %>% select(ID, Tuition, FinSource)
...
bps_df0722_xm0725 <- combine
write.csv(bps_df0722_xm0725,"~/Documents/2020_2Summer/research/0Yale2009/data/output/bps_df0722_xm0725.csv", row.names = TRUE)
...
x_merged <- as.data.frame(table(c(x1$ID, x2$ID, x3$ID, x4$ID, x5$ID))) %>% filter(Freq > 1) %>% select(Var1)

check_out <- data %>%
  filter(ID %in% x_merged$Var1)

write.csv(check_out,"~/Documents/2020_2Summer/research/0Yale2009/data/output/outlier_df0722_xm0726.csv", row.names = TRUE)
