...
combo <- df %>%
  mutate(
    fin1 = ifelse(str_detect(FinSource, "a."), 1, 0),
    fin2 = ifelse(str_detect(FinSource, "b."), 1, 0),
    fin3 = ifelse(str_detect(FinSource, "c."), 1, 0),
    fin4 = ifelse(str_detect(FinSource, "d."), 1, 0),
    fin5 = ifelse(str_detect(FinSource, "e."), 1, 0),
  )
head(combo)
