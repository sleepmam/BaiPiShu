...
df <- as.data.frame(data_0719_s)[,-c(283:289)]
head(df)
dim(df)
```
...
bps_df0719_xm0719_v2 <- total
write.csv(bps_df0719_xm0719_v2,"~/Documents/2020_2Summer/research/0Yale2009/data/output/bps_df0719_xm0719_v2.csv", row.names = TRUE)
